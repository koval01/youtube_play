...
'<a href="mailto:$1">$1</a>')},numberWithCommas=a=>a.toString().replace(/\B(?<!\.\d*)(?=(\d{3})+(?!\d))/g,","),getRandomInt=(a,b)=>{a=Math.ceil(a);b=Math.floor(b);return Math.floor(Math.random()*(b-a)+a)},repeatStringNumTimes=(a,b)=>{let c="";for(;0<b;)c+=a,b--;return c},requestCall=(a,b,c,d=!1,f=null)=>{let e=new XMLHttpRequest,g={};e.open(c,b,!0);"POST"===c.toUpperCase()&&(e.setRequestHeader("Content-Type","application/json;charset=UTF-8"),g=JSON.stringify(f));e.onload=function(){200<=e.status&&
